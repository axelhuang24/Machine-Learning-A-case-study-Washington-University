...
sel = randperm(size(X, 1)); % returns a vector containing a random permutation of the integers 1:m
sel = sel(1:100);
...
%  returns the cost only.  After implementing the feedforward to compute the cost, we can verify that
